...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var allNumbers = "Farras Is Most Handsome Man In This World, You Dont Believe Me? If You See Him, You Will Fainted"
        //menambahkan allNumbers ke table data
        tableData = allNumbers.components(separatedBy: " ")
        
        //deklarasi index number
        var indexNumber = "F A R R A S  S O   H A N D S O M E  "
